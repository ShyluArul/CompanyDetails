...
public class EmployeeController {
	...
	public ResponseEntity<Employee> getEmployeeById(@PathVariable(name = "employeeId") Long employeeId) {
		...
		if (employee == null) {
			throw new EmployeeNotFoundException("No employee find with id : " + employeeId + ". Please enter valid id");
		}
	...
	public ResponseEntity<Employee> getEmployeeByName(@PathVariable(name = "employeeName") String employeeName) {
		...
		if (employee == null) {
			throw new EmployeeNotFoundException("No employee find with Name : " + employeeName + ". Please enter valid name");
		}
		return new ResponseEntity<Employee>(employee, HttpStatus.OK);
	}
